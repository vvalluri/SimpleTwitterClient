...
public class UserTimelineFragment extends TweetListFragment {
	...
	public static UserTimelineFragment newInstance(String sname) {
		UserTimelineFragment userFragment = new UserTimelineFragment();
        Bundle args = new Bundle();
        args.putString("screenname", sname);
	...
	public void onScrollPopulateTimeline (int count) {
		onScroll = true;
		onRefresh = false;
    	populateUserTimeline(count);
		return;
	}
	
	protected void populateUserTimeline(int totalItemsCount) {
			...
			Client.getUserTimeline(screenname, local_maxid, local_sinceid, new JsonHttpResponseHandler() {
				@Override
